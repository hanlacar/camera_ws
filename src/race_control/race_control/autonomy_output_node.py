...
class AutonomyOutputNode(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(Bool, self.param("speed_valid_topic"), lambda m: self.set_value("speed_valid", bool(m.data)), 10)
        self.create_subscription(Float32, self.param("speed_kph_topic"), lambda m: self.set_number("speed_kph", m.data), 10)
